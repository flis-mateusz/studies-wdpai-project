 ...
 * @var ?AnimalType $dogType
 * @var ?AnimalType $catType
 */
        ...
        <section class="announcements">
            <section>
                <?php if (isset($announcements) && !isEmpty($announcements)) : ?>
                    ...
                    <section class="panel-elements cut">
                        <?php
