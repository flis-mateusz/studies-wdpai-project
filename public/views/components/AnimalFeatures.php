        ...
        foreach ($this->features as $feature) {
            ...
            <div>
                ...
                <div class="checkboxes">
                    <input type="radio" id="charac-$id-yes" name="charac-$id" value="1" />
                    <label class="yes" for="charac-$id-yes">Tak</label>
                    <input type="radio" id="charac-$id-no" name="charac-$id" value="-1" />
                    <label class="no" for="charac-$id-no">Nie</label>
                    <input type="radio" id="charac-$id-not-sure" name="charac-$id" value="0" checked />
